...
var dict: [String:Bool] = ["Anchovies": false, "Coconut": true, "Cilantro": true, "Liver": false]
...
print(studioAlbums.filter({ (k,v) -> Bool in
    return k.lowercased().contains("led zeppelin")
}).count)
